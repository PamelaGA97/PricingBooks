...
namespace Database.Models
{
    public class Price : Entity
    {
        ...
        public int PercentOffer { get; set; } //oferta por porcentaje del producto los valores admitidos son del 0 % (caso en el que no existe una oferta) hasta el 100% caso en el que el producto ya es gratis
